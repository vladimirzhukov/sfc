    ...
    <header class="absolute inset-x-0 top-0 z-50">
        <nav aria-label="Global" class="flex items-center justify-between p-6 lg:px-8">
            ...
            <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                @if (Auth::check())
                    <a href="{{ route('app::index') }}" class="text-sm/6 font-semibold text-white">{{ __('Dashboard') }}</a>
                @else
                    <a href="{{ route('login') }}" class="text-sm/6 font-semibold text-white">{{ __('Log in') }} <span aria-hidden="true">&rarr;</span></a>
                @endif
            </div>
        </nav>
        <el-dialog>
                    ...
                    <el-dialog-panel class="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-gray-900 p-6 sm:max-w-sm sm:ring-1 sm:ring-gray-100/10">
                        ...
                        <div class="mt-6 flow-root">
                            <div class="-my-6 divide-y divide-gray-500/25">
                                ...
                                <div class="py-6">
                                    @if (Auth::check())
                                        <a href="{{ route('app::index') }}" class="-mx-3 block rounded-lg px-3 py-2.5 text-base/7 font-semibold text-white hover:bg-white/5">{{ __('Dashboard') }}</a>
                                    @else
                                        <a href="{{ route('login') }}" class="-mx-3 block rounded-lg px-3 py-2.5 text-base/7 font-semibold text-white hover:bg-white/5">{{ __('Log in') }}</a>
                                    @endif
                                </div>
                            </div>
                        </div>
        ...
        <div class="mx-auto max-w-7xl px-6 pt-16 pb-8 sm:pt-24 lg:px-8 lg:pt-32">
                    ...
                    <div class="md:grid md:grid-cols-2 md:gap-8">
                        ...
                        <div class="mt-10 md:mt-0">
                            ...
                            <ul role="list" class="mt-6 space-y-4">
                                ...
                                <li><a href="{{ route('web::privacy') }}" class="text-sm/6 text-gray-400 hover:text-white">{{ __('Privacy Policy') }}</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="mt-8 border-t border-white/10 pt-8 md:flex md:items-center md:justify-between">
                <div class="flex gap-x-6 md:order-2">
                    ...
                    <a href="https://www.tiktok.com/#" target="_blank" class="text-gray-400 hover:text-white">
                    ...
                    <a href="https://www.threads.com/#" target="_blank" class="text-gray-400 hover:text-white">
