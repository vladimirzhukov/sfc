                        ...
                        <ul role="list" class="flex flex-1 flex-col gap-y-7">
                            <li>
                                <ul role="list" class="-mx-2 space-y-1">
                                    <li><a href="{{ route('app::index') }}" class="group flex gap-x-3 rounded-md{{ ((Route::currentRouteName() != 'app::index') ? ' hover:bg-gray-50' : ' bg-gray-50') }} p-2 text-sm/6 font-semibold{{ ((Route::currentRouteName() != 'app::index') ? ' hover:text-indigo-600' : ' text-indigo-600') }}"><svg class="size-6 shrink-0{{ ((Route::currentRouteName() != 'app::index') ? ' hover:text-indigo-600' : ' text-indigo-600') }}" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="m4 12 8-8 8 8M6 10.5V19a1 1 0 0 0 1 1h3v-3a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3h3a1 1 0 0 0 1-1v-8.5"/></svg> {{ __('Dashboard') }}</a></li>
                                    <li><a href="{{ route('app::community') }}" class="group flex gap-x-3 rounded-md{{ ((Route::currentRouteName() != 'app::community') ? ' hover:bg-gray-50' : ' bg-gray-50') }} p-2 text-sm/6 font-semibold{{ ((Route::currentRouteName() != 'app::community') ? ' hover:text-indigo-600' : ' text-indigo-600') }}"><svg class="size-6 shrink-0{{ ((Route::currentRouteName() != 'app::community') ? ' hover:text-indigo-600' : ' text-indigo-600') }}" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon"><path stroke="currentColor" stroke-linecap="round" stroke-width="1.5" d="M4.5 17H4a1 1 0 0 1-1-1 3 3 0 0 1 3-3h1m0-3.05A2.5 2.5 0 1 1 9 5.5M19.5 17h.5a1 1 0 0 0 1-1 3 3 0 0 0-3-3h-1m0-3.05a2.5 2.5 0 1 0-2-4.45m.5 13.5h-7a1 1 0 0 1-1-1 3 3 0 0 1 3-3h3a3 3 0 0 1 3 3 1 1 0 0 1-1 1Zm-1-9.5a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Z"/></svg> {{ __('Community') }}</a></li>
                                    <li><a href="{{ route('app::startups') }}" class="group flex gap-x-3 rounded-md{{ ((Route::currentRouteName() != 'app::startups') ? ' hover:bg-gray-50' : ' bg-gray-50') }} p-2 text-sm/6 font-semibold{{ ((Route::currentRouteName() != 'app::startups') ? ' hover:text-indigo-600' : ' text-indigo-600') }}"><svg class="size-6 shrink-0{{ ((Route::currentRouteName() != 'app::startups') ? ' hover:text-indigo-600' : ' text-indigo-600') }}" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8 7H5a2 2 0 0 0-2 2v4m5-6h8M8 7V5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2m0 0h3a2 2 0 0 1 2 2v4m0 0v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-6m18 0s-4 2-9 2-9-2-9-2m9-2h.01"/></svg> {{ __('Startups') }}</a></li>
                                    <li><a href="{{ route('app::business') }}" class="group flex gap-x-3 rounded-md{{ ((Route::currentRouteName() != 'app::business') ? ' hover:bg-gray-50' : ' bg-gray-50') }} p-2 text-sm/6 font-semibold{{ ((Route::currentRouteName() != 'app::business') ? ' hover:text-indigo-600' : ' text-indigo-600') }}"><svg class="size-6 shrink-0{{ ((Route::currentRouteName() != 'app::business') ? ' hover:text-indigo-600' : ' text-indigo-600') }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M6 4h12M6 4v16M6 4H5m13 0v16m0-16h1m-1 16H6m12 0h1M6 20H5M9 7h1v1H9V7Zm5 0h1v1h-1V7Zm-5 4h1v1H9v-1Zm5 0h1v1h-1v-1Zm-3 4h2a1 1 0 0 1 1 1v4h-4v-4a1 1 0 0 1 1-1Z"/></svg> {{ __('Business') }}</a></li>
                                    <li><a href="{{ route('app::events') }}" class="group flex gap-x-3 rounded-md{{ ((Route::currentRouteName() != 'app::events') ? ' hover:bg-gray-50' : ' bg-gray-50') }} p-2 text-sm/6 font-semibold{{ ((Route::currentRouteName() != 'app::events') ? ' hover:text-indigo-600' : ' text-indigo-600') }}"><svg class="size-6 shrink-0{{ ((Route::currentRouteName() != 'app::events') ? ' hover:text-indigo-600' : ' text-indigo-600') }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 10h16m-8-3V4M7 7V4m10 3V4M5 20h14a1 1 0 0 0 1-1V7a1 1 0 0 0-1-1H5a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1Zm3-7h.01v.01H8V13Zm4 0h.01v.01H12V13Zm4 0h.01v.01H16V13Zm-8 4h.01v.01H8V17Zm4 0h.01v.01H12V17Zm4 0h.01v.01H16V17Z"/></svg> {{ __('Events') }}</a></li>
                                    <li><a href="{{ route('app::services') }}" class="group flex gap-x-3 rounded-md{{ ((Route::currentRouteName() != 'app::services') ? ' hover:bg-gray-50' : ' bg-gray-50') }} p-2 text-sm/6 font-semibold{{ ((Route::currentRouteName() != 'app::services') ? ' hover:text-indigo-600' : ' text-indigo-600') }}"><svg class="size-6 shrink-0{{ ((Route::currentRouteName() != 'app::services') ? ' hover:text-indigo-600' : ' text-indigo-600') }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M11 9h6m-6 3h6m-6 3h6M6.996 9h.01m-.01 3h.01m-.01 3h.01M4 5h16a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1Z"/></svg> {{ __('Services') }}</a></li>
                            ...
                            <li class="mt-auto"><a href="{{ route('app::profile') }}" class="group -mx-2 flex gap-x-3 rounded-md{{ ((Route::currentRouteName() != 'app::profile') ? ' hover:bg-gray-50' : ' bg-gray-50') }} p-2 text-sm/6 font-semibold text-gray-700{{ ((Route::currentRouteName() != 'app::profile') ? ' hover:text-indigo-600' : ' text-indigo-600') }}"><svg class="size-6 shrink-0{{ ((Route::currentRouteName() != 'app::profile') ? ' hover:text-indigo-600' : ' text-indigo-600') }}" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon"><path stroke-linecap="round" stroke-linejoin="round" d="M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55 0 1.02.398 1.11.94l.213 1.281c.063.374.313.686.645.87.074.04.147.083.22.127.325.196.72.257 1.075.124l1.217-.456a1.125 1.125 0 0 1 1.37.49l1.296 2.247a1.125 1.125 0 0 1-.26 1.431l-1.003.827c-.293.241-.438.613-.43.992a7.723 7.723 0 0 1 0 .255c-.008.378.137.75.43.991l1.004.827c.424.35.534.955.26 1.43l-1.298 2.247a1.125 1.125 0 0 1-1.369.491l-1.217-.456c-.355-.133-.75-.072-1.076.124a6.47 6.47 0 0 1-.22.128c-.331.183-.581.495-.644.869l-.213 1.281c-.09.543-.56.94-1.11.94h-2.594c-.55 0-1.019-.398-1.11-.94l-.213-1.281c-.062-.374-.312-.686-.644-.87a6.52 6.52 0 0 1-.22-.127c-.325-.196-.72-.257-1.076-.124l-1.217.456a1.125 1.125 0 0 1-1.369-.49l-1.297-2.247a1.125 1.125 0 0 1 .26-1.431l1.004-.827c.292-.24.437-.613.43-.991a6.932 6.932 0 0 1 0-.255c.007-.38-.138-.751-.43-.992l-1.004-.827a1.125 1.125 0 0 1-.26-1.43l1.297-2.247a1.125 1.125 0 0 1 1.37-.491l1.216.456c.356.133.751.072 1.076-.124.072-.044.146-.086.22-.128.332-.183.582-.495.644-.869l.214-1.28Z" /><path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" /></svg> {{ __('Profile') }}</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
